...
registerSetTimer('autorotate', 2, function() {
...
eventHTMLElem('mouseleave', 'materials', true, function(event) {
  assignMat('Materials', getEntityByName(getHTMLElemAttribute('value', 'materials', true), 'MATERIAL'));
