...
rotatespeed = 2;
autoRotateCamera(true, rotatespeed);
autorotate = true;

registerOnClick(['ALL_OBJECTS'], false, false, [2], function() {
  if (autorotate == true) {
    rotatespeed = rotatespeed * -1;
    autoRotateCamera(false, rotatespeed);
    autorotate = false;
  } else {
    autoRotateCamera(true, rotatespeed);
    autorotate = true;
...
eventHTMLElem('mouseleave', 'materials', true, function(event) {
  assignMat('Material', getEntityByName(getHTMLElemAttribute('value', 'materials', true), 'MATERIAL'));
  console.log('change material: ' + String(getHTMLElemAttribute('value', 'materials', true)));
});
